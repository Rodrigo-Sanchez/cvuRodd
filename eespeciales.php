						...
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control" onfocus="ponDatos()" name="otro1" id="otro1"  /> 
									</div>
								...
								<div class="row" style="margin-bottom:7px;">
									<div class="col-sm-2">
									<label for="sel1">Nombre del estímulo <span style="color:red;">*</span>:</label>
									</div>
									<div class="col-sm-4">
										<?php
								
											$listaEstimulos = getListadoEcatedra();
								
										?>
										
										<select id="estimulo" class="form-control" name="estimulo" >
											<option value="0">Seleccionar</option>
											<?php
					...
					<form id="paraBuscar">
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="row" style="margin-bottom:7px;">
									<div class="col-sm-3">
									<label for="sel1">Nombre del estímulo:</label>
									</div>
									<div class="col-sm-9">
										
										<input type="text" class="form-control" name="nombreEst"  />
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Estímulos, programas, premios y reconocimientos obtenidos - <i>Estímulos Especiales</i> </h4></center>
