		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header" style="background-color:#1F618D; color:white;">
					<div class="row">
						<div class="col-sm-10">
							<p>Agregar Material didáctico</p>
						</div>
						<div class="col-sm-2">
							...
							<div class="row">
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-4">
										...
										<option value="1">Diseño de estrategia didáctica original</option>
										<option value="1">Diseño de prácticas de laborario (con protocolo)</option>
										<option value="3">Elaboración de colección de problemas</option>
										<option value="4">Producción de materiales audiovisuales para asignaturas curriculares</option>
										<option value="5">Traducción de materiales audiovisuales para asignaturas curriculares</option>
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-4">
										...
										<select id="tipo2" class="form-control" name="tipo2" onchange="habilitaB()" >
											...
											<option value="5">Seminario</option>
											<option value="6">Teoría</option>
											<option value="9">Otro</option>
										</select>
								...
								<div class="row" style="margin-bottom:7px;">
									<div class="col-sm-2">
									<label for="sel1">Cargo desempeñado <span style="color:red;">*</span>:</label>
									</div>
									<div class="col-sm-4">
										<input type="hidden" name="numeroEmpleado" value="<?= $nt ?>" />
										...
										<option value="4">Esudiante</option>
										<option value="9">Otro</option>
									</select>
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Elaboración de Material Didáctico</h4></center>
			...
			<div class="row" style="margin-top:20px;">
				<div class="col-md-12">
					...
					<button type="button" onclick="abreAgregar()" class="btn btn-info" style="float:right; margin-left:50px;" ><span class="glyphicon glyphicon-plus"></span> Agregar Material </button>
