						...
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="row" style="margin-bottom:7px;">
									<div class="col-sm-3">
									<label for="sel1">Título de la conferencia <span style="color:red;">*</span>: </label>
									</div>
									<div class="col-sm-9">
								...
								<div class="row" style="margin-bottom:7px;">
									<div class="col-sm-3">
									<label for="sel1">Por invitación <span style="color:red;">*</span>: </label>
									</div>
									<div class="col-sm-9">
	...
	<div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="mi-modal3">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Si no encontraste la red que querías agregar en el catálogo del SIIA,  proporciona los siguientes datos</p>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="row" style="margin-bottom:7px;">
									<div class="col-sm-3">
									<label for="sel1">Número de proyecto<span style="color:red;">*</span>:</label>
									</div>
									<div class="col-sm-9">
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Divulgación - <i>Conferencias aisladas</i> </h4></center>
