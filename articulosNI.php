<?php
	...
	$ptotales = count(getListaPublicacionesNoIndArt($idPersona));
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Documentos no indexados - <i>Artículos</i> </h4></center>
			...
			<?php
				...
				$lista = getListaPublicacionesNoIndArt($idPersona);
					...
					<input type="hidden" name="nt" value="<?= $nt ?>" />
						...
						<table id="example" style="font-size:12px;  " class="display" cellspacing="0" >
							...
							foreach($lista as $l) {
								...
								$autores = getAutoresNoIndexadas($identificador);
								$cadenaAutores="";
								$cuentaAutores=1;
