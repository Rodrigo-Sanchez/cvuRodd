<?php
	...
	$ptotales = count(getTesisTutoradas($nt));
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Busca la Tesis que asesoraste</p>
					...
					<form id="paraBuscar">
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="row">
									<div class="col-sm-3">
									<label for="sel1">Nombre de la Tesis:</label>
								...
								<div class="row" style="margin-top:12px;">
									<span> Si la tesis que buscabas no apareció, da click 
				...
				<div class="modal-body">
					...
					<?php	
						foreach($publicacionesQuiereAgregar as $p) {
							...
							if($obs=="El academico quiere agregar una tesis SIIA en calidad de Asesor") {
					...
					<?php
						...
						$pubsQuiere2 = getDetallesQuiereAgregarNOSIIATesis2($nt);
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>TesiUNAM - <i>Tesis tutoradas</i> </h4></center>
