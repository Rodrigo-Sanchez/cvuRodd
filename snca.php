										...
										<select id="entidadUNAM" class="form-control" name="entUNAM" >
											...
											<?php
												foreach($listaAreas as $e) { ?>
													<option value="<?= $e['CodigoEstimuloOtorgado']?>"><?= utf8_encode($e['EstimuloOtorgado']) ?></option>
											<?php
												}
											?>
										</select>
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Estímulos, programas, premios y reconocimientos obtenidos - <i>SNCA</i> </h4></center>
