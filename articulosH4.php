<?php
	...
	$ptotales = count(getLibrosCoordinadosHumanindex($nt));
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Humanindex - <i> Libros coordinados</i></h4></center>
			...
			<?php
				...
				$lista = getLibrosCoordinadosHumanindex($nt);
					...
					<input type="hidden" name="nt" value="<?= $nt ?>" />
						...
						<table id="example" style="font-size:12px;  " class="display" cellspacing="0" >
							...
							foreach($lista as $l) {
								...
								$autores = getAutoresLibrosHumanindex($identificador);	
								$cuentaAutores=1;
