						...
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-5">
									<input type="text" onchange="ponPlantel()" onfocus="habilita2()" class="form-control" id="tags" name="tags" placeholder="Escriba el nombre de la institución o un segmento representativo" />	
									</div>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header" style="background-color:#1F618D; color:white;">
					<div class="row">
						<div class="col-sm-10">
							<p>Grupos externos en revisión para agregarse a tu lista</p>
						</div>
						<div class="col-sm-2">
							<button type="button" class="close" data-dismiss="modal">&times;</button>
						</div>
				...
				<div class="modal-body">
					...
					<?php	
						foreach($publicacionesQuiereAgregar as $p) {
							...
							<li>Universidad:<?= $ent ?>, Título: <?= $p['tituloTesis'] ?>, Nombre:<?= $p['autor'] ?>, Año: <?=  $p[utf8_decode('añoExamen')] ?>		
							</li>
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Docencia impartida - <i>Grupos atendidos en otras instituciones</i> </h4></center>
			...
			<div class="row" style="margin-top:20px;">
				<div class="col-md-12">
					...
					<button type="button" onclick="abreAgregar()" class="btn btn-info" style="float:right; margin-left:50px;" ><span class="glyphicon glyphicon-plus"></span> Agregar Grupo </button>
