					...
					<form id="paraBuscar">
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="row">
									<div class="col-sm-12">
									Si la red que quieres añadir a tu lista, no apareció, da click <button type="button" onclick="abreAgregar2()" class="btn btn-info" > aquí </button>
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Redes de investigación - <i>Redes CONACyT</i> </h4></center>
