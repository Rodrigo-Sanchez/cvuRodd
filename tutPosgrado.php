								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-6">
										<div class="row">
											...
											<div class="col-sm-9">
												<input type="text" onchange="ponNivelesPosgrado()" class="form-control" id="tags" name="tags" placeholder="Escriba el nombre de la institución o un segmento representativo" />	
											</div>
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Docencia - <i>Tutorías de Posgrado</i> </h4></center>
