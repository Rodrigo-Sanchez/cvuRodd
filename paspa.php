						...
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="row" style="margin-bottom:7px;">
									<div class="col-sm-3">
									<label for="sel1">Estímulo Otorgado <span style="color:red;">*</span>:</label>
									</div>
									<div class="col-sm-3">
										...
										<?php
											...
											$listaEstimulos = getEstimulosNombrePASPA();
								
										?>
										
										<select id="entidadUNAM" class="form-control" name="entUNAM" onchange="habilitaA()">
											<option value="0">Seleccionar</option>
											<?php
												foreach($listaEstimulos as $e) { ?>
													<option value="<?= $e['EstimuloOtorgado']?>"><?= utf8_encode($e['EstimuloOtorgado']) ?></option>
											<?php
												}
											?>
								...
								<div class="row" style="margin-bottom:7px;">
									<div class="col-sm-3">
									<label for="sel1">Gran Área <span style="color:red;">*</span>:</label>
									</div>
									<div class="col-sm-3">
										<input type="hidden" name="numeroEmpleado" value="<?= $nt ?>" />
										...
										<?php
											...
											$listaAreas = getGranAreasPASPA();
								
										?>
										
										<select id="entidadUNAM2" class="form-control" name="entUNAM" onchange="habilitaB()" >
											<option value="0">Seleccionar</option>
											<?php
												foreach($listaAreas as $e) { ?>
													<option value="<?= $e['GranArea']?>"><?= utf8_encode($e['GranArea']) ?></option>
											<?php
												}
											?>
											<option value="9">Otro</option>
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-3">
										...
										<?php
											...
											$listaAreas = getAreasPASPA();
								
										?>
										
										<select id="entidadUNAM3" class="form-control" name="entUNAM" onchange="habilitaC()" >
											<option value="0">Seleccionar</option>
											<?php
												foreach($listaAreas as $e) { ?>
													<option value="<?= $e['Area']?>"><?= utf8_encode($e['Area']) ?></option>
											<?php
												}
											?>
											<option value="9">Otro</option>
								...
								<div class="row" style="margin-bottom:7px;">
									<div class="col-sm-3">
									<label for="sel1">País destino <span style="color:red;">*</span>:</label>
									</div>
									<div class="col-sm-9">
...
<option value="Zimbabue" id="ZW">Zimbabue</option>
								...
								<div class="row" style="margin-bottom:7px;">
									<div class="col-sm-3">
									<label for="sel1">Entidad destino <span style="color:red;">*</span>:</label>
									</div>
									<div class="col-sm-9">
										<input type="text" class="form-control" name="edestino"  />
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Estímulos, programas, premios y reconocimientos obtenidos - <i>PASPA</i> </h4></center>
			...
			<div class="row" style="margin-top:20px;">
				<div class="col-md-12">
					...
					<button type="button" onclick="abreAgregar()" class="btn btn-info" style="float:right; margin-left:50px;" ><span class="glyphicon glyphicon-plus"></span> Agregar Estímulo </button>
