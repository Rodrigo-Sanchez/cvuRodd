							...
							<div class="row">
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-4">
										...
										<option value="1">Comité académico de Posgrado</option>
										<option value="1">Consejo académico de área</option>
										<option value="3">Consejo Técnico</option>
										<option value="4">Consejo Universitario</option>
										<option value="4">Junta de gobierno</option>
									</select>
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Órganos colegiados</h4></center>
			...
			<div class="row" style="margin-top:20px;">
				<div class="col-md-12">
					...
					<button type="button" onclick="abreAgregar()" class="btn btn-info" style="float:right; margin-left:50px;" ><span class="glyphicon glyphicon-plus"></span> Agregar Órgano coleagiado </button>
