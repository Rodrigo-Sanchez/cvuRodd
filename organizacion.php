							...
							<div class="row">
										...
										<div class="row">
											...
											<div class="col-sm-8">
												<select id="programa" class="form-control" name="programa" onchange="habilitaA()" >
													...
													<option value="1">Actividades académicas</option>
													<option value="2">Actividades de difusión</option>
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-6">
										<div class="row">
											<div class="col-sm-4">
												<label for="sel1">Terminada <span style="color:red;">*</span>:</label>
											</div>
											<div class="col-sm-8">
												<label><input type="radio" name="optradio" >Sí </label>
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-6">
										<div class="row">
											<div class="col-sm-4">
												<label for="sel1">No. aprox. asistentes <span style="color:red;">*</span>:</label>
											</div>
											<div class="col-sm-8">
												<input type="text" class="form-control" />
											</div>
									...
									<div class="col-sm-6">
										<div class="row">
											<div class="col-sm-4">
												<label for="sel1">No. organizadores <span style="color:red;">*</span>:</label>
											</div>
											<div class="col-sm-8">
												<input type="text" class="form-control" /> 
											</div>
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-6">
										<div class="row">
											<div class="col-sm-4">
												<label for="sel1">No. inst. organizadoras <span style="color:red;">*</span>:</label>
											</div>
											<div class="col-sm-8">
												<input type="text" class="form-control" />
											</div>
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Divulgación - <i>Organización de actividades</i> </h4></center>
...
function ponPlanes() {
	...
	$.ajax({
		type: 'POST',
		url: 'programasTutoriasAmbos.php',
