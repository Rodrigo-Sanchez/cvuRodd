						...
						<div class="form-group">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="row" style="margin-bottom:7px;">
										<div class="col-sm-5">
										<label for="sel1">Actividad formativa de investigación <span style="color:red;">*</span>:</label>
										</div>
										<div class="col-sm-7">
											<select id="tipo" class="form-control" name="tipo" onchange="actualizarMenu()" >
												<option value="0">Seleccionar</option>
												<option value="1">Estancia corta</option>
												<option value="2">Jóvenes hacia la investigación</option>
												<option value="3">Otra estancia</option>
											</select>
										</div>
									</div>
								</div>
								...
								<div class="col-sm-6">
									<div class="row" style="margin-bottom:7px;">
										<div class="col-sm-5">
										<label for="sel1">Nombre de la investigación <span style="color:red;">*</span>:</label>
										</div>
										<div class="col-sm-7">
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="row" style="margin-bottom:7px;">
										...
										<div class="col-sm-7">
											<select id="nivel" class="form-control" name="nivel" onchange="actualizarPlantel()" >
												<option value="0">Seleccionar</option>
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="row" style="margin-bottom:7px;">
										<div class="col-sm-5">
										<label for="sel1">Escuela <span style="color:red;">*</span>:</label>
										</div>
										<div id="escuelas" class="col-sm-7">
											<?php
											...
											<select id="escuela" class="form-control" name="escuela" onchange="habilitaA()" >
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="row" style="margin-bottom:7px;">
										<div class="col-sm-5">
										<label for="sel1">Semestre/Año <span style="color:red;">*</span>:</label>
										</div>
										<div class="col-sm-7">
											<input type="text" class="form-control" />
										</div>
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="row" style="margin-bottom:7px;">
										<div class="col-sm-5">
										<label for="sel1">No. horas de duración de la estancia <span style="color:red;">*</span>:</label>
										</div>
										<div class="col-sm-7">
											<input type="text" class="form-control" />
										</div>
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4> Investigación - <i> Formación en la investigación</i> </h4></center>
			...
			<div class="row" style="margin-top:20px;">
				<div class="col-md-12">
					...
					<button type="button" onclick="abreAgregar()" class="btn btn-info" style="float:right; margin-left:50px;" ><span class="glyphicon glyphicon-plus"></span> Agregar Formación </button>
...
<script>
	function actualizarMenu() {
		...
		if(opcion==2) {
			...
			$.ajax({
				type: 'POST',
				url: 'bachilleratosPlanteles.php',
				data: {op:opcion},
				success:function(data) {  
					$('#escuela').html(data);  
				}
