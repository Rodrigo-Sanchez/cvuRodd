						...
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="row" style="margin-bottom:7px;">
									<div class="col-sm-2">
									<label for="sel1">Miembro de <span style="color:red;">*</span>:</label>
									</div>
									<div class="col-sm-4">
										<input type="hidden" name="numeroEmpleado" value="<?= $nt ?>" />
										<select id="tipo" class="form-control" name="tipo" onchange="habilitaA()" >
										<option value="0">Seleccionar</option>
										<option value="1">Comité de becas alimentarias</option>
										<option value="2">Comité de estancias cortas</option>
										<option value="3">Comité de información documental </option>
										<option value="4">Comité de Servicio Social </option>
										<option value="5">Comité de Superación Académica (subprogramas 121 y 127) </option>
										<option value="6">Comité de Superación Académica </option>
										<option value="7"> Consejo asesor de docencia   </option>
										<option value="8"> Consejo asesor de investigación   </option>
										<option value="88"> Coordinación de seguridad      </option>
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Órganos asesores</h4></center>
			...
			<div class="row" style="margin-top:20px;">
				<div class="col-md-12">
					...
					<button type="button" onclick="abreAgregar()" class="btn btn-info" style="float:right; margin-left:50px;" ><span class="glyphicon glyphicon-plus"></span> Agregar Órgano asesor </button>
