<?php
	...
	$entidades = getEntidadesConPatentes();
						...
						<div class="form-group">
							...
							<div class="row">
								...
								<?php
									...
									$listaEntidades = getEntidadesConPatentes();
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Propiedad industrial - <i>Patentes solicitadas</i> </h4></center>
			...
			<?php
				$lista = getPatentesSolACademico($nombreAcademico);
			?>
			<div class="row">
