						...
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-4">
										<select id="tipo"  class="form-control"  onchange="habilitaA()" >
											<option value="0">Seleccionar</option>
											<option value="1">Comisión del PRIDE</option>
											<option value="3">Comisión Dictaminadora</option>
											<option value="4">Jurado calificador de Concurso de oposición</option>
											<option value="9">Otra comisión de prueba</option>
										</select>
									</div>
									<div class="col-sm-1">
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<input type="text" onchange="ponPlantel()" class="form-control" id="tags" name="tags" placeholder="Escriba el nombre de la institución o un segmento representativo" />	
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Otras actividades por reportar - <i>Comisiones evaluadoras</i> </h4></center>
			...
			<div class="row" style="margin-top:20px;">
				<div class="col-md-12">
					...
					<button type="button" onclick="abreAgregar()" class="btn btn-info" style="float:right; margin-left:50px;" ><span class="glyphicon glyphicon-plus"></span> Agregar Comisión </button>
