		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Busque el curso especial que quiere agregar a su docencia impartida</p>
						...
						<div class="form-group">
							...
							<div class="row">
								...
								<?php
									...
									$listaEntidades = getEntidadesCursosEspeciales();
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<?php
										foreach($listaEntidades as $e) { ?>
											<option value="<?= utf8_encode($e['Entidad'])?>"><?= utf8_encode($e['Entidad']) ?></option>
									<?php
										}
									?>
									</select>
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-9">
										...
										<select id="anioEspecial" class="form-control" name="anioEspecial" onchange="cambiaMateria()" > 
											<option value='0'>Seleccionar</option>
										</select>	
								...
								<div class="row">
									<div class="col-sm-12">
									Si el curso que quiere añadir a su lista, no apareció después de la búsqueda, de click <button type="button" onclick="abreAgregar2()" class="btn btn-info" > aquí </button>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header" style="background-color:#1F618D; color:white;">
					<div class="row">
						<div class="col-sm-10">
							<p>Agregar curso especial nuevo</p>
						</div>
						<div class="col-sm-2">
							<button type="button" class="close" data-dismiss="modal">&times;</button>
						</div>
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Docencia - <i>Cursos especiales </i> </h4></center>
			...
			<div class="row" style="margin-top:20px;">
				<div class="col-md-12">
					...
					<button type="button" onclick="abreAgregar()" class="btn btn-info" style="float:right; margin-left:50px;" ><span class="glyphicon glyphicon-plus"></span> Agregar curso especial</button>
...
$('select.changeStatus').change(function(){
	$.ajax({
		type: 'POST',
		url: 'aniosEspeciales.php',
		data: {entidadUNAM: $('select.changeStatus').val()},
		success:function(data) {  
			$('#anioEspecial').html(data);  
		}
    });
...
<script>
function cambiaMateria() {
	var e = $( "#entidadUNAM option:selected" ).val();
	var m = $( "#anioEspecial option:selected" ).val();
	$.ajax({
		type: 'POST',
		url: 'asignaturasEspeciales.php',
