<?php
	...
	$ptotales = count(getLibrosAutoriaHumanindex($nt));
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Humanindex - <i> Libros, autoría propia </i></h4></center>
			...
			<?php
				...
				$lista = getLibrosAutoriaHumanindex($nt);
