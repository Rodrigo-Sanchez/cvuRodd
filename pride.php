...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Estímulos, programas, premios y reconocimientos obtenidos - <i>PRIDE</i> </h4></center>
					...
					<input type="hidden" name="nt" value="<?= $nt ?>" />
						...
						<table id="example" style="font-size:12px;  " class="display" cellspacing="0" >
							...
							foreach($lista as $l) {
								...
								<tr>
									<td><?= $contador ?></td>
									<td>PRIDE <?= utf8_encode($l['EstimuloOtorgado']) ?></td>
