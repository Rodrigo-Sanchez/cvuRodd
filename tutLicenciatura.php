					...
					<form id="paraBuscar">
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="row">
									<div class="col-sm-12">
									Si la tutoría que desea añadir a su lista, no se localizó a través de la búsqueda, de click <button type="button" onclick="abreAgregar2()" class="btn btn-info" > aquí </button>
...
?>
	...
	<div class="row">
        <div class="col-md-3" style="background-color:#303C64;">
			...
			?>
				<center><h5 style="color:#00375;"><b><?= $datos[0]['NombreCompleto'] ?></h5></b></center>
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Docencia - <i>Tutorías de Licenciatura</i> </h4></center>
			...
			<div class="row" style="margin-top:20px;">
				<div class="col-md-12">
					...
					<button type="button" onclick="abreAgregar()" class="btn btn-info" style="float:right; margin-left:50px;" ><span class="glyphicon glyphicon-plus"></span> Agregar Tutoría </button>
