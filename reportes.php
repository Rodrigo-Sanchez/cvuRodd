		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Busca el reporte que quieres agregar a tu lista</p>
						...
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<select id="anioReporte" class="form-control changeStatus" name="anioReporte" >
										<option value="0">Seleccionar</option>
									<?php
										foreach($anios as $e) { ?>
											<option value="<?= $e['anio']?>"><?= utf8_encode($e['anio']) ?></option>
									<?php
										}
									?>
									</select>
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-9">
										...
										<select id="entidad" class="form-control" name="entidad" onchange="ponTitulo()" > 
											<option value='0'>Seleccionar</option>
										</select>	
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-9">
										...
										<select id="titulosReportes" class="form-control" name="titulosReportes" style="text-overflow: ellipsis;"> 
											<option value='0'>Seleccionar</option>
										</select>
								...
								<div class="row">
									<div class="col-sm-12">
									Si el reporte que quieres añadir a tu lista, no apareció, da click <button type="button" onclick="abreAgregar2()" class="btn btn-info" > aquí </button>
	...
	<div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="mi-modal3">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Si no encontraste el reporte que querías agregar en el catálogo del SIIA,  proporciona los siguientes datos</p>
...
?>
	...
	<div class="row">
        <div class="col-md-3" style="background-color:#52A4B7;">
			...
			?>
				<div style="padding-top:10px;">
					<center>
						<img src="imagenes/hombre.png" width="60%" style="border-radius: 50%; background-color:white;" />
					</center>
				</div>
			...
			?>	
				...
				<div style="padding-top:10px;">
					<center>
						<img src="imagenes/mujer.png" width="60%" style="border-radius: 50%; background-color:white;" />
					</center>
				</div>
			...
			?>
				<center><h5 style="color:white;"><b><?= $datos[0]['NombreCompleto'] ?></h5></b></center>
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Reportes técnicos - <i>CIC</i> </h4></center>
			...
			<?php
				$lista = getReportesTecnicosCIC($nt);
			?>
			<div class="row">
						...
						<table id="example" style="font-size:12px;  " class="display" cellspacing="0" >
							...
							foreach($lista as $l) {
								...
								<tr>
									...
									<td><?= utf8_encode($l['EntidadSolicita']) ?></td>
									<td><?= utf8_encode($l['CalidadDe']) ?></td>
									<td><?= $l['anio'] ?></td>
			...
			<div class="row" style="margin-top:20px;">
				<div class="col-md-12">
					...
					<button type="button" onclick="abreAgregar()" class="btn btn-info" style="float:right; margin-left:50px;" ><span class="glyphicon glyphicon-plus"></span> Agregar reporte</button>
...
$('select.changeStatus').change(function(){
	$.ajax({
		type: 'POST',
		url: 'entidadesReportes.php',
		data: {anioReporte: $('select.changeStatus').val()},
		success:function(data) {  
			$('#entidad').html(data);  
		}
    });
...
<script>
function ponTitulo() {
	var a = $( "#anioReporte option:selected" ).val();
	var e = $( "#entidad option:selected" ).val();
	$.ajax({
		type: 'POST',
		url: 'titulosReportes.php',
		data: {anio: a, entidad: e},
		success:function(data) {  
			$('#titulosReportes').html(data);  
		}
    });
