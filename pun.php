						...
						<div class="form-group">
							...
							<div class="row">
								<div class="col-sm-12">
									...
									<p>Para aclaraciones relacionadas al PUN, favor de comunicarse a.... 
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Estímulos, programas, premios y reconocimientos obtenidos - <i>PUN</i> </h4></center>
