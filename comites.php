							...
							<div class="row">
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-6">
										<div class="row">
											...
											<div class="col-sm-9">
												<input type="text" onchange="ponNivelesLic()" class="form-control" id="tags" name="tags" placeholder="Escriba el nombre de la institución o un segmento representativo" />	
											</div>
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-6">
										<div class="row">
											...
											<div class="col-sm-9">
												<select id="nivel" class="form-control" name="nivel" onchange="ponPlanes()" >
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-12">
										<div class="row">
											<div class="col-sm-2">
												<label for="sel1">Nombre del alumno:</label>
											</div>
											<div class="col-sm-10">
												<input type="text" class="form-control" />
											</div>
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Otras opciones de titulación en la UNAM - <i>Participación en comités tutorales de alumnos de posgrado</i> </h4></center>
			...
			<div class="row" style="margin-top:20px;">
				<div class="col-md-12">
					...
					<button type="button" onclick="abreAgregar()" class="btn btn-info" style="float:right; margin-left:50px;" ><span class="glyphicon glyphicon-plus"></span> Agregar Opción </button>
...
<script>
function ponNivelesLic() {
	var uni = $( "#tags" ).val();
	$.ajax({
		type: 'POST',
		url: 'nivelesTutorias.php',
