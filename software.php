		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header" style="background-color:#1F618D; color:white;">
					<div class="row">
						<div class="col-sm-10">
							<p>Agregar Desarrollo de Software</p>
						</div>
						<div class="col-sm-2">
						...
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-1">
										<label for="sel1">Url <span style="color:red;">*</span>:</label>
									</div>
									<div class="col-sm-5">
										<input type="text" class="form-control" name="estimulo"  />
									</div>
								...
								<div class="row" style="margin-bottom:7px;">
									<div class="col-sm-4">
									<label for="sel1">No. de participantes además de usted <span style="color:red;">*</span>:</label>
									</div>
									<div class="col-sm-2">
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Desarrollo de software</h4></center>
			...
			<div class="row" style="margin-top:20px;">
				<div class="col-md-12">
					...
					<button type="button" onclick="abreAgregar()" class="btn btn-info" style="float:right; margin-left:50px;" ><span class="glyphicon glyphicon-plus"></span> Agregar Desarrollo </button>
