		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header" style="background-color:#1F618D; color:white;">
					<div class="row">
						<div class="col-sm-10">
							<p>Agregar Opción de titulación</p>
						</div>
						<div class="col-sm-2">
									...
									<div class="col-sm-6">
										<div class="row">
											...
											<div class="col-sm-9">
												...
												<select id="entidadUNAM" class="form-control" name="entidadUNAM" onchange="ponNiveles()" >
											...
											<?php
												...
												foreach($entidades as $e) { ?>
													...
													<option value="<?=$e['NombrePlantel'] ?>"><?= utf8_encode($e['NombrePlantel']) ?></option>
								...
								<div class="row" style="margin-bottom:7px;">
									...
									<div class="col-sm-6">
										<div class="row">
											...
											<div class="col-sm-9">
												<select id="nivel" class="form-control" name="nivel" onchange="ponCarreras()" >
												<option value="0">Seleccionar</option>
												</select>	
											</div>
									...
									<div class="col-sm-6">
										<div class="row">
											...
											<div class="col-sm-9">
												...
												<select id="opcionTit" class="form-control" name="opcionTit" onchange="habilitaA()" >
													<option value="0">Seleccionar
													<option value="1">Actividad de investigación</option>
													<option value="2">Actividades de apoyo a la docencia</option>
													<option value="3">Examen general de conocimientos (EGEL)</option>
													<option value="4">Informe de servicio social</option>
													<option value="5">Posgrado</option>
													<option value="6">Profundización de conocimientos</option>
													<option value="7">Seminario de Tesis o Tesina</option>
													<option value="8">Trabajo profesional</option>
...
?>
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color:white; padding-bottom:50px; ">
			...
			<div class="row">
				<div class="col-md-12">
					<center><h4><b><?= $datos[0]['NombreCompleto'] ?></b></h4><h4>Actividades de apoyo a la titulación </h4></center>
			...
			<div class="row" style="margin-top:20px;">
				<div class="col-md-12">
					...
					<button type="button" onclick="abreAgregar()" class="btn btn-info" style="float:right; margin-left:50px;" ><span class="glyphicon glyphicon-plus"></span> Agregar Actividad </button>
